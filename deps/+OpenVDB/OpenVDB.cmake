...
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DBOOST_LOG_NO_THREADS  --Wno-missing-template-arg-list-after-template-kw -ferror-limit=0")
#set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -DBOOST_LOG_NO_THREADS  -Wno-missing-template-arg-list-after-template-kw -ferror-limit=0")
#set(CMAKE_CXX_FLAGS_Release "${CMAKE_CXX_FLAGS_Release} -DBOOST_LOG_NO_THREADS   -Wno-missing-template-arg-list-after-template-kw -ferror-limit=0")
