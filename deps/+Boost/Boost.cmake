...
ExternalProject_Add(Boost
    ...
    INSTALL_COMMAND env CMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS_${_build_type_upper}} -pthread -pthreads -Wno-unused-private-field -m32"  emmake ./b2 cxxflags=-DPTHREADS cxxflags=-DBOOST_THREAD_POSIX cxxflags=-pthread cxxflags=-DTHREAD install link=static  toolset=emscripten threading=single address-model=32  --prefix=${${PROJECT_NAME}_DEP_INSTALL_PREFIX} system filesystem regex chrono iostreams random atomic nowide thread log --with-log --with-system --with-filesystem  --with-locale --with-regex --with-chrono --with-atomic --with-date_time --with-iostreams --with-thread --with-nowide
    CMAKE_ARGS
