///|/ Copyright (c) Prusa Research 2021 - 2022 Lukáš Matěna @lukasmatena, Lukáš Hejl @hejllukas,
...
void detect_platform() {
    ...
    s_platform_flavor = PlatformFlavor::GenericOSX;
    {
        ...
        s_platform_flavor = PlatformFlavor::
    }
    ...
    // Test for Chromium.
    {
        ...
        if (f) {
            ...
            if (::fgets(buf, 4096, f)) {
                ...
                } else if (strstr(buf, "microsoft") != nullptr ||
